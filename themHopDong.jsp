        ...
        <div id="page-wrapper">
			<div class="container" style="margin-left:375px; margin-top:24px;">
				...
				<div class="group-asset">
					...
					<html:form action="/themHopDong" method="get">
						<div style="float: left;">
							<table class="table-info">
								...
								<tr class="row-tableInfo">
									<td colspan="2">
										<center>
											<html:button property="themKhachHang" styleClass="btn btn-primary">Thêm</html:button>
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
												...
												<td><a href="file:///E:/camdo/Quanlicamdo/ChiTietHopDong.html"/>Thêm hợp đồng</a></td>
                                            </tr>
                                            </logic:iterate>
                                        </tbody>
                                    </table>
